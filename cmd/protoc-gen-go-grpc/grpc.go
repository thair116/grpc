...
const (
	...
	grpcPackage    = protogen.GoImportPath("github.com/thair116/grpc")
	codesPackage   = protogen.GoImportPath("github.com/thair116/grpc/codes")
	statusPackage  = protogen.GoImportPath("github.com/thair116/grpc/status")
)
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("//")
	g.P("// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/github.com/thair116/grpc/?tab=doc#ClientConn.NewStream.")
