...
[`UnaryClientInterceptor`](https://godoc.org/github.com/thair116/grpc#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/thair116/grpc#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/thair116/grpc#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/thair116/grpc#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/thair116/grpc#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/thair116/grpc#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/thair116/grpc#StreamServerInterceptor)
...
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/thair116/grpc#StreamInterceptor).
