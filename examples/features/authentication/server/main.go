...
import (
	...
	"github.com/thair116/grpc/examples/data"
	"github.com/thair116/grpc/metadata"
	"github.com/thair116/grpc/status"

	pb "github.com/thair116/grpc/examples/features/proto/echo"
)
...
func main() {
	...
	opts := []grpc.ServerOption{
		...
		// https://godoc.org/github.com/thair116/grpc#StreamInterceptor
...
func ensureValidToken(ctx context.Context, req interface{}, info *grpc.UnaryServerInfo, handler grpc.UnaryHandler) (interface{}, error) {
	...
	// See: https://godoc.org/github.com/thair116/grpc/metadata#New
