...
```shell
$ go get github.com/thair116/grpc
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/github.com/thair116/grpc/examples/route_guide
```
...
`$GOPATH/src/github.com/thair116/grpc/examples/route_guide`, simply:
