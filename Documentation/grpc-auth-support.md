...
Clients may use
[metadata.MD](https://godoc.org/github.com/thair116/grpc/metadata#MD)
to store tokens and other authentication-related data. To gain access to the
`metadata.MD` object, a server may use
[metadata.FromIncomingContext](https://godoc.org/github.com/thair116/grpc/metadata#FromIncomingContext).
...
to lowercase. See [here](https://godoc.org/github.com/thair116/grpc/metadata#New).

It is possible to configure token validation for all RPCs using an interceptor.
A server may configure either a
[grpc.UnaryInterceptor](https://godoc.org/github.com/thair116/grpc#UnaryInterceptor)
or a
[grpc.StreamInterceptor](https://godoc.org/github.com/thair116/grpc#StreamInterceptor).

## Adding a token to all outgoing client RPCs

To send an OAuth2 token with each RPC, a client may configure the
`grpc.DialOption`
[grpc.WithPerRPCCredentials](https://godoc.org/github.com/thair116/grpc#WithPerRPCCredentials).
Alternatively, a client may also use the `grpc.CallOption`
[grpc.PerRPCCredentials](https://godoc.org/github.com/thair116/grpc#PerRPCCredentials)
on each invocation of an RPC.

To create a `credentials.PerRPCCredentials`, use
[oauth.NewOauthAccess](https://godoc.org/github.com/thair116/grpc/credentials/oauth#NewOauthAccess).
