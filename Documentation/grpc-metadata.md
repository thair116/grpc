...
A metadata can be created using package [metadata](https://godoc.org/github.com/thair116/grpc/metadata).
...
Header and trailer sent along with a unary call can be retrieved using function [Header](https://godoc.org/github.com/thair116/grpc#Header) and [Trailer](https://godoc.org/github.com/thair116/grpc#Trailer) in [CallOption](https://godoc.org/github.com/thair116/grpc#CallOption):
...
Header and trailer can be retrieved from the returned stream using function `Header` and `Trailer` in interface [ClientStream](https://godoc.org/github.com/thair116/grpc#ClientStream):
...
To send header and trailer to client in unary call, the server can call [SendHeader](https://godoc.org/github.com/thair116/grpc#SendHeader) and [SetTrailer](https://godoc.org/github.com/thair116/grpc#SetTrailer) functions in module [grpc](https://godoc.org/github.com/thair116/grpc).
...
For streaming calls, header and trailer can be sent using function `SendHeader` and `SetTrailer` in interface [ServerStream](https://godoc.org/github.com/thair116/grpc#ServerStream):
