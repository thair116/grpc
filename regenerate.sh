...
echo "go install github.com/thair116/protobuf/cmd/protoc-gen-go"
(cd test/tools && go install github.com/thair116/protobuf/cmd/protoc-gen-go)
...
# one of the sources.
OPTS=Mgrpc/service_config/service_config.proto=/internal/proto/grpc_service_config,Mgrpc/core/stats.proto=github.com/thair116/grpc/interop/grpc_testing/core
...
mkdir -p ${WORKDIR}/out/github.com/thair116/grpc/balancer/rls/internal/proto/grpc_lookup_v1
mv ${WORKDIR}/out/github.com/thair116/grpc/lookup/grpc_lookup_v1/* ${WORKDIR}/out/github.com/thair116/grpc/balancer/rls/internal/proto/grpc_lookup_v1

# grpc_testingv3/testv3.pb.go is not re-generated because it was
# intentionally generated by an older version of protoc-gen-go.
rm ${WORKDIR}/out/github.com/thair116/grpc/reflection/grpc_testingv3/*.pb.go
...
cp -R ${WORKDIR}/out/github.com/thair116/grpc/* .
